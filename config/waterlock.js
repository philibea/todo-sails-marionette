...
module.exports.waterlock = {
  ...
  postActions: {
    ...
    login: {
      ...
      // string - 'custom json response string'
      // default - 'default'
      failure: {controller: 'auth', action: 'failedToLogin'}
    },
    ...
    logout: {
      ...
      // string - 'custom json response string'
      // default - 'default'
      success: {controller: 'main', action: 'index'},
      ...
      // string - 'custom json response string'
      // default - 'default'
      failure: {controller: 'main', action: 'index'}
    },
    // post register event
    register: {
      // This can be any one of the following
      ...
      // string - 'custom json response string'
      // default - 'default'
      failure: {controller: 'auth', action: 'failedToRegister'}
    }
  }
};
